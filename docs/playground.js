...
(async () => {
  ...
  async function handleLanguageChange() {
    ...
    if (!languagesByName[newLanguageName]) {
      const url = 'https://raw.githubusercontent.com/the-mikedavis/tree-sitter-iex/main/tree-sitter-iex.wasm'
  ...
  function loadState() {
    const language = localStorage.getItem("languageIEx");
    const sourceCode = localStorage.getItem("sourceCodeIEx");
    const query = localStorage.getItem("queryIEx");
    const queryEnabled = localStorage.getItem("queryEnabledIEx");
  ...
  function saveState() {
    localStorage.setItem("languageIEx", languageSelect.value);
    localStorage.setItem("sourceCodeIEx", codeEditor.getValue());
    saveQueryState();
  }

  function saveQueryState() {
    localStorage.setItem("queryEnabledIEx", queryCheckbox.checked);
    localStorage.setItem("queryIEx", queryEditor.getValue());
  }
